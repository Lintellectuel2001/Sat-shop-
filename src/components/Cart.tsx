              ...
              {items.map((item) => (
                <div key={item.product.id} className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center mt-2">
                      <button
                        ...
                        className="px-2 py-1 bg-gray-100 dark:bg-zinc-800 rounded-l hover:bg-gray-200 dark:hover:bg-zinc-700 transition"
                      >
                        -
                      </button>
                      ...
                      <button
                        ...
                        className="px-2 py-1 bg-gray-100 dark:bg-zinc-800 rounded-r hover:bg-gray-200 dark:hover:bg-zinc-700 transition"
                      >
                        +
                      </button>
                    </div>
                  ...
                  <button
                    ...
                    className="p-2 text-red-500 hover:text-red-600 hover:bg-gray-100 dark:hover:bg-zinc-800 rounded-lg transition"
                  >
                    <X size={20} />
                  </button>
                </div>
          ...
          {items.length > 0 && items.every(item => item.product.paymentLink) ? (
            items.map((item) => (
              <a
                ...
                className="flex items-center justify-center w-full bg-black dark:bg-white text-white dark:text-black py-3 rounded-full font-semibold hover:bg-gray-800 dark:hover:bg-gray-200 transition mb-2"
              >
