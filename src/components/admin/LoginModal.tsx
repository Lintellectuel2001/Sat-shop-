  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white dark:bg-zinc-900 p-6 rounded-lg w-full max-w-md relative">
        ...
        <h2 className="text-xl font-bold mb-6 text-gray-900 dark:text-white">Connexion Administrateur</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 rounded-lg bg-gray-100 dark:bg-zinc-800 border border-gray-300 dark:border-zinc-700 focus:outline-none focus:border-blue-500 dark:focus:border-white text-gray-900 dark:text-white"
              required
            />
          </div>
